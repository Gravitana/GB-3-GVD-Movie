package com.example.gvdmovie.googlemaps
...
import com.example.gvdmovie.databinding.FragmentMapsBinding
...
class GoogleMapsFragment(
    val lat: Double = 52.52000659999999,
    val lng: Double = 13.404953999999975
) : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
        map = googleMap
        val initialPlace = LatLng(lat, lng)
        map.moveCamera(
